...
{
    public static int dfs(int start,boolean []visited, int remaining, int [][]skip)
    {
        ...
        for(int i = 1;i<=9;i++)
        {
            ...
            {
                ans += dfs(i,visited,remaining-1,skip);
            }
    ...
    public static void main(String[] args)
    {
        ...
        {
            // int remaining = i-1;
            sum +=dfs(2,visited,i-1,skip)*4;
            sum +=dfs(1,visited,i-1,skip)*4;
            sum +=dfs(5,visited,i-1,skip);
        }
